...
namespace MarsPic
{
    class MySQL
    {
        ...
        {
            MySqlConnection myConn = new MySqlConnection("server=localhost;user id=root; password=MySQL; database=" + database + "; pooling=false;port=3306");
            myConn.Open();
